<script context="module">
    ...
    import { loggedIn, currentTable, currentTicket, cartProducts, currentTableName, returnHome} from '../stores.js';
    ...
    afterUpdate(() => {
      ...
      tab => new BSN.Tab( tab, {height: true} )
        ...
        var myModal = document.getElementById('tableModal');
      ...
      router('/');
        ...
        db.version(15).stores({
            category: "Id",
            products: "++id,Id,GroupCode,portion_id",
